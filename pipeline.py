...
def cmd_update(args):
    ...
    while dia <= hasta:
        ...
        if dia.day == 1 or dia == hasta:
            c.commit(); print(f"  … {dia}  (+{nuevas} OC nuevas acumuladas)")
...
def main():
    ...
    u.add_argument("--dias", type=int, default=14); u.set_defaults(func=cmd_update)
    ...
    r.add_argument("--dias", type=int, default=14)
